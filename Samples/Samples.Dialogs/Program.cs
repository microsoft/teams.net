...
public static partial class Program
{
    ...
    private static void RegisterMinimalApiHandlers(Microsoft.Teams.Apps.App teams, IConfiguration configuration)
    {
        ...
        // Handle task fetch using minimal API
        teams.OnTaskFetch(async context =>
        {
            var activity = context.Activity;
            ...
            return dialogType switch
            {
                ...
                "webpage_dialog" => CreateWebpageDialog(configuration, context.Log),
        ...
        // Handle task submit using minimal API
