...
Without it, Teams never delivers attachments to the bot. `context.Files.ListAsync()` returns an empty list and this sample replies asking for a file, even though the user attached one.
