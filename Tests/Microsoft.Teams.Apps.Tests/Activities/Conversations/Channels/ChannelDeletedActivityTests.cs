...
public class ChannelDeletedActivityTests
{
    private readonly App _app;
    private readonly IToken _token = Globals.Token;
    private readonly Controller _controller = new();

    public ChannelDeletedActivityTests()
    {
    ...
    public async Task Should_CallHandler()
    {
        ...
        _app.OnChannelDeleted(context =>
        {
            calls++;
            Assert.True(context.Activity.Type.IsConversationUpdate);
            Assert.Equal(ConversationUpdateActivity.EventType.ChannelDeleted, context.Activity.ChannelData?.EventType);
    ...
    public class Controller
    {
        ...
        [Conversation.ChannelDeleted]
        public void OnChannelDeleted([Context] IContext.Next next)
        {
            Calls++;
            next();
        }
