...
public class ChannelMemberAddedActivityTests
{
    ...
    public ChannelMemberAddedActivityTests()
    {
    ...
    public async Task Should_CallHandler()
    {
        ...
        _app.OnChannelMemberAdded(context =>
        {
            calls++;
            Assert.True(context.Activity.Type.IsConversationUpdate);
            Assert.Equal(ConversationUpdateActivity.EventType.ChannelMemberAdded, context.Activity.ChannelData?.EventType);
        ...
        var res = await _app.Process<TestPlugin>(_token, new ConversationUpdateActivity()
        {
            ChannelData = new()
            {
                EventType = ConversationUpdateActivity.EventType.ChannelMemberAdded
            }
        });
    ...
    public class Controller
    {
        ...
        [Conversation.ChannelMemberAdded]
        public void OnChannelMemberAdded([Context] IContext.Next next)
        {
            Calls++;
            next();
        }
