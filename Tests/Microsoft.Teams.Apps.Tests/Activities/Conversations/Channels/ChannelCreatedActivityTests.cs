...
public class ChannelCreatedActivityTests
{
    ...
    public ChannelCreatedActivityTests()
    {
    ...
    public async Task Should_CallHandler()
    {
        ...
        _app.OnChannelCreated(context =>
        {
            calls++;
            Assert.True(context.Activity.Type.IsConversationUpdate);
            Assert.Equal(ConversationUpdateActivity.EventType.ChannelCreated, context.Activity.ChannelData?.EventType);
    ...
    public class Controller
    {
        ...
        [Conversation.ChannelCreated]
        public void OnChannelCreated([Context] IContext.Next next)
        {
            Calls++;
            next();
        }
