...
public class UserTokenClientTests
{
    ...
    public async Task UserTokenClient_GetAsync_WithRegionalEndpoint()
    {
        ...
        var userTokenClient = new UserTokenClient(mockHandler.Object, apiClientSettings);

        var reqBody = await userTokenClient.GetAsync(tokenRequest);

        Assert.Equal("validToken", reqBody.Token);

        string expectedUrl = "https://europe.token.botframework.com/api/usertoken/GetToken?userId=userId-aad&connectionName=connectionName&channelId=webchat&code=200";
        mockHandler.Verify(x => x.SendAsync<Token.Response>(It.Is<IHttpRequest>(arg => arg.Url == expectedUrl), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task UserTokenClient_GetAadAsync_WithRegionalEndpoint()
    {
        ...
        string expectedUrl = "https://europe.token.botframework.com/api/usertoken/GetAadTokens?userId=userId-aad&connectionName=connectionName&channelId=webchat&resourceUrls%5b0%5d=value1&resourceUrls%5b1%5d=value2";
        mockHandler.Verify(x => x.SendAsync<IDictionary<string, Token.Response>>(It.Is<IHttpRequest>(arg => arg.Url == expectedUrl), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task UserTokenClient_GetStatusAsync_WithRegionalEndpoint()
    {
        ...
        string expectedUrl = "https://europe.token.botframework.com/api/usertoken/GetTokenStatus?userId=userId-aad&channelId=webchat&includeFilter=validEntry";
        mockHandler.Verify(x => x.SendAsync<IList<Token.Status>>(It.Is<IHttpRequest>(arg => arg.Url == expectedUrl), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task UserTokenClient_SignOutAsync_WithRegionalEndpoint()
    {
        ...
        string expectedUrl = "https://europe.token.botframework.com/api/usertoken/SignOut?userId=userId-aad&connectionName=connectionName&channelId=msteams";
    ...
    public async Task UserTokenClient_ExchangeAsync_WithRegionalEndpoint()
    {
        ...
        Assert.Equal("validToken", reqBody.Token);
        HttpMethod expectedMethod = HttpMethod.Post;
        string expectedUrl = "https://europe.token.botframework.com/api/usertoken/exchange?userId=userId-aad&connectionName=connectionName&channelId=msteams";
        mockHandler.Verify(x => x.SendAsync<Token.Response>(It.Is<IHttpRequest>(arg => arg.Url == expectedUrl && arg.Method == expectedMethod), It.IsAny<CancellationToken>()), Times.Once);
    }
