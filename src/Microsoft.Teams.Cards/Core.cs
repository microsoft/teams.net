...
public class ExecuteAction : Action
{
    ...
    /// 
    /// `iconUrl` also accepts the `icon:<icon-name>[,regular|filled]` format to display an icon from the vast [Adaptive Card icon catalog](https://adaptivecards.microsoft.com/?topic=icon-catalog) instead of an image. For example, use `icon:Calendar` for the regular style or `icon:Calendar,filled` for the filled style.
    /// </summary>
...
public class Container : CardElement
{
    ...
    /// <summary>
    /// Controls if the container should bleed into its parent. A bleeding container extends into its parent's padding. See [Edge-to-edge content](https://adaptivecards.microsoft.com/?topic=edge-to-edge-content) for more information.
    /// </summary>
...
public class ChoiceSetInput : CardElement
{
    ...
    /// </summary>
    [JsonPropertyName("style")]
    public ChoiceSetInputStyle? Style { get; set; }
