...
`core/`. It starts with the application-level changes and then covers detailed
API migrations.

The primary comparison is:

- `Libraries/Microsoft.Teams.Apps` and its public types from
  `Libraries/Microsoft.Teams.Api`, `Microsoft.Teams.Common`, and
  `Microsoft.Teams.Cards`
- `core/src/Microsoft.Teams.Apps` and `core/src/Microsoft.Teams.Core`
...
| Area | Legacy `Libraries/` model | Current `core/` model | Impact |
|---|---|---|---|
...
The following compatibility members exist in `core/`. They may produce
...
## Additions in `core/`: not breaking
