...
public class TeamsBotApplication : BotApplication
{
    ...
    /// <param name="agenticIdentity">The agentic identity used for request scoping. Create it from an inbound activity's <c>Recipient</c> via <see cref="ChannelAccount.GetAgenticUser"/> and <see cref="AgenticIdentity.FromAgenticUser"/>.</param>
