...
#pragma warning restore CS0618
    ...
    private BotRequestContext? AgenticIdentityContext => _agenticIdentity is null ? null : BotRequestContext.FromAgenticIdentity(_agenticIdentity);
    ...
    {
        return _client.CreateConversationAsync(request, _serviceUrl, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    public Task<SendActivityResponse?> CreateActivityAsync(string conversationId, TeamsActivityInput activity, Dictionary<string, string>? additionalHeaders = null, CancellationToken cancellationToken = default)
    {
        ...
        return _client.SendActivityAsync(conversationId, activity, _serviceUrl, isTargeted: false, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(activity);
        return _client.UpdateActivityAsync(conversationId, id, activity, _serviceUrl, isTargeted: false, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        return _client.DeleteActivityAsync(conversationId, id, _serviceUrl, isTargeted: false, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(activity);
        return _client.SendActivityAsync(conversationId, activity, _serviceUrl, isTargeted: true, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(activity);
        return _client.UpdateActivityAsync(conversationId, id, activity, _serviceUrl, isTargeted: true, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        return _client.DeleteActivityAsync(conversationId, id, _serviceUrl, isTargeted: true, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        IList<ChannelAccount> members = await _client.GetConversationMembersAsync(conversationId, _serviceUrl, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        PagedMembersResult? paged = await _client.GetConversationPagedMembersAsync(
            ...
            pageSize,
            continuationToken,
            requestContext: AgenticIdentityContext,
    ...
    {
        return _client.GetConversationMemberAsync<T>(conversationId, memberId, _serviceUrl, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        return _client.AddReactionAsync(conversationId, activityId, reactionType, _serviceUrl, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
    ...
    {
        return _client.DeleteReactionAsync(conversationId, activityId, reactionType, _serviceUrl, requestContext: AgenticIdentityContext, customHeaders: additionalHeaders, cancellationToken: cancellationToken);
    }
