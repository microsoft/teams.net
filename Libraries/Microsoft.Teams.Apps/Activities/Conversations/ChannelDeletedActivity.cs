...
public static partial class Conversation
{
    ...
    public class ChannelDeletedAttribute() : UpdateAttribute(ConversationUpdateActivity.EventType.ChannelDeleted)
    {
        public override bool Select(IActivity activity)
        {
            ...
            {
                return update.ChannelData?.EventType == ConversationUpdateActivity.EventType.ChannelDeleted;
            }
...
{
    public static App OnChannelDeleted(this App app, Func<IContext<ConversationUpdateActivity>, Task> handler)
    {
    ...
    public static App OnChannelDeleted(this App app, Func<IContext<ConversationUpdateActivity>, CancellationToken, Task> handler)
    {
        app.Router.Register(new Route()
        {
            Name = string.Join("/", [ActivityType.ConversationUpdate, ConversationUpdateActivity.EventType.ChannelDeleted]),
