...
{
    public static App OnTeamRestored(this App app, Func<IContext<ConversationUpdateActivity>, Task> handler)
    {
    ...
    public static App OnTeamRestored(this App app, Func<IContext<ConversationUpdateActivity>, CancellationToken, Task> handler)
    {
        app.Router.Register(new Route()
        {
            Name = string.Join("/", [ActivityType.ConversationUpdate, ConversationUpdateActivity.EventType.TeamRestored]),
