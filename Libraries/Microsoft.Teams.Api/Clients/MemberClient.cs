...
public class MemberClient : Client
{
    ...
    public MemberClient(string serviceUrl, IHttpClient client, string scope, CancellationToken cancellationToken = default) : base(client, scope, cancellationToken)
    {
        ServiceUrl = serviceUrl;
    }
    ...
    public async Task<List<Account>> GetAsync(string conversationId)
    {
        ...
        var response = await _http.SendAsync<List<Account>>(request, null, _cancellationToken);
    ...
    public async Task<Account> GetByIdAsync(string conversationId, string memberId)
    {
        ...
        var response = await _http.SendAsync<Account>(request, null, _cancellationToken);
        return response.Body;
    }
    ...
    public async Task DeleteAsync(string conversationId, string memberId)
    {
        ...
        await _http.SendAsync(request, null, _cancellationToken);
    }
}